...
state_borders = m_shaperead('../borders/ne_10m_admin_1_states_provinces');
info = ncinfo(ncfile);
...
m_proj('miller', 'lon', [-87 -76], 'lat', [24 31]);
set(gca,'color','b');
...
m_coast('patch', rgbColor, 'edgecolor', 'none');
hold on

plot_borders('county', county_borders, 'state', state_borders);
...
filename = 'images/stormTrackPlots_TSR-CSU_AprilFcst_Florida.jpg';
